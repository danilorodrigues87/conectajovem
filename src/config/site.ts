/**
 * Marca e conteúdo fixo do portal (Master editará depois).
 */
export const site = {
  name: 'Conecta Jovem',
  ...
  hero: {
    ...
    title: 'O futuro do trabalho começa com a conexão certa',
    subtitle:
      'Encontre vagas perto de você, construa seu currículo e candidate-se em poucos cliques. Empresas parceiras e escolas parceiras impulsionam sua jornada.',
  ...
  about:
    'O Conecta Jovem é a marca responsável pela plataforma. Escolas e empresas atuam como parceiras na conexão entre formação e mercado de trabalho.',
} as const;
